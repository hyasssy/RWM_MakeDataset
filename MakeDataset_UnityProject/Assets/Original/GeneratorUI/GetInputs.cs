...
namespace RWM.VR
{
    ...
    {
        [SerializeField] TMP_InputField playArea;
        ...
        [SerializeField] GameObject fileNameRoot;
        [SerializeField] GameObject streetIdRoot;
        [SerializeField] GameObject startLatLngRoot;
        ...
        public InputDatas GetInputsFunction()
        {
            ...
            var list =
                new List<(string fileName, string streetId, double startLat, double startLng, double endLat, double
                    endLng)>();
        ...
        List<string> GetInfosFromRoot(GameObject root)
        {
            ...
            inputFields.ForEach(infoReceiver => { result.Add(infoReceiver.GetInfo()); });
            return result;
        }
    }
    ...
    public class InputDatas
    {
        ...
        public List<(string fileName, string streetId, double startLat, double startLng, double endLat, double endLng)>
            videoDatas;
        ...
        public InputDatas(
            ...
            List<(string fileName, string streetId, double startLat, double startLng, double endLat, double endLng)>
                input_videoDatas)
        {
